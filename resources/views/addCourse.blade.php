...
<body>
    <div class="center">
        ...
        <form action='getCourseRegisterInfo' method="POST">
            @csrf
            <input class="txt_filed" type="text" name="id" placeholder="ID" /><br>
            ...
            <input class="txt_filed" type="text" name="teacher" placeholder="Teacher's name" /><br>
            <span style="color:red">@error ('teacher') {{$message}} @enderror</span><br><br>
            <input class="txt_filed" type="text" name="year" placeholder="Year" /><br>
