...
<body>
    <div class="center">
        ...
        <form action='getRegisterInfo' method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <input class="txt-field" type="text" name="gpa" placeholder="GPA" /><br>
            <span style="color:red">@error ('gpa') {{$message}} @enderror</span><br>
            <a href="https://gpacalculator.net/college-gpa-calculator/">GPA Calculator</a><br><br>
